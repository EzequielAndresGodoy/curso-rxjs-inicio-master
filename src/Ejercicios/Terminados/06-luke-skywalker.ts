 ...
 *  de la petición anterior, y tomar la especie starships[0],
...
(() =>{
    ...
    getRequest(`${SW_API}/people/1/`).pipe(
        ...
        //FORMA UNO - No muy buena
          // pluck('starships','0'),
          // switchMap(resp => zip(getRequest(`${SW_API}/people/1/`), getRequest(resp))),
          // map(resp=>{
          //   return {
          //     especie: resp[1],
          //     personaje: resp[0]
